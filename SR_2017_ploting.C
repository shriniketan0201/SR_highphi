...

{
  ...
  */ 
  ...
  cout<<"******************************** " << histo_data->GetEntries()<<  " " << histo_data->GetIntegral()<< endl;
  ...
  Int_t int_data = histo_data->Integral();
  Int_t test_data= histo_data->Integral();

  cout<<"++++++++++******************************** " << histo_data->GetEntries()<<  " " << histo_data->Integral()<<  " " << int_data << " " << test_data <<endl;
  ...
  */
  ...
  TFile *f_WMuNu = new TFile("WToMuNu_M.root");
