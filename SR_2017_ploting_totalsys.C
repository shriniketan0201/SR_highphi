...
void plot_signal(string histname_string, string sample_name, Float_t xsec, int nevents_total, string outfile_name)
{
  ...
  double photon_scale_factor_unc = 0.009/0.984; // combining pix seed and pho ID components //0.01150
...

{
  ...
  */ 
  ...
  TString histname_uncorrected = TString(histname_string+"_20"); // Dphi(jets,MET): 29, phoPt/MET: 22
  TString histname_qcdscale = TString(histname_string+"_23"); // Dphi(jets,MET): 30, phoPt/MET: 23
  TString histname_straightUp = TString(histname_string+"_21");
  TString histname_straightDown = TString(histname_string+"_22");
  TString histname_twistedUp = TString(histname_string+"_31");
  TString histname_twistedDown = TString(histname_string+"_32");
  TString histname_gammaUp = TString(histname_string+"_33");
  TString histname_gammaDown = TString(histname_string+"_34");
  TString histname_phoSFUp = TString(histname_string+"_35");
  TString histname_phoSFDown = TString(histname_string+"_36");
  ...
  double photon_scale_factor_unc = 0.009/0.984; // combining pix seed and pho ID components
  ...
  //  TFile *f_data = new TFile("Data_all_new.root");
  ...
  int int_data = histo_data->Integral();
  ...
  pesdown_shift.clear();
  std::vector<double> phoscaleup_shift;
  phoscaleup_shift.clear();
  std::vector<double> phoscaledown_shift;
  phoscaledown_shift.clear();
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    phoscaleup_shift.push_back(0);
    phoscaledown_shift.push_back(0);
  ...
  TFile *f_jetfake = new TFile("QCD_data_all.root");
  //  TFile *f_jetfake = new TFile("Qcd_all_new.root");
  ...
  */
  ...
  //  TFile *f_elefake = new TFile("Wenu_all_new.root");
  ...
  */
  ...
  //TFile* f_ZNuNuG = new TFile("Znunugamma17_LO_new.root");
  TFile* f_ZNuNuG = new TFile("ZNunuGamma_LO_june22.root");
  ...
  //below lines are added Sept21,22
  TH1F* histo_ZNuNuG_phoscaleUp = (TH1F*)((TH1F*)f_ZNuNuG->Get(histname_phoSFUp))->Clone("histo_ZNuNuG_phoscaleUp");
  histo_ZNuNuG_phoscaleUp->SetBinContent(nBins, histo_ZNuNuG_phoscaleUp->GetBinContent(nBins)+histo_ZNuNuG_phoscaleUp->GetBinContent(nBins+1));
  histo_ZNuNuG_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_ZNuNuG_phoscaleDown = (TH1F*)((TH1F*)f_ZNuNuG->Get(histname_phoSFDown))->Clone("histo_ZNuNuG_phoscaleDown");
  histo_ZNuNuG_phoscaleDown->SetBinContent(nBins, histo_ZNuNuG_phoscaleDown->GetBinContent(nBins)+histo_ZNuNuG_phoscaleDown->GetBinContent(nBins+1));
  histo_ZNuNuG_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  */ 
  ...
  histo_ZNuNuG->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354); // LO sample entries and xsec June
  histo_ZNuNuG_uncorrected->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354); // 329894(standard) + 1710471(ext) = 1510494
  histo_ZNuNuG_JESUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_JESDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_PESUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_PESDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_straightUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_straightDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_twistedUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_twistedDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_gammaUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_gammaDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_qcdscale->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  /*  histo_ZNuNuG_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354); // 329894(standard) + 1710471(ext) = 1510494
  histo_ZNuNuG_uncorrected_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354); // 329894(standard) + 1710471(ext) = 1510494
  histo_ZNuNuG_JESUp_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_JESDown_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_PESUp_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_PESDown_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_straightUp_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_straightDown_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_twistedUp_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_twistedDown_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_gammaUp_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_gammaDown_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  histo_ZNuNuG_qcdscale_ext->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354);
  ...
  */
  ...
  Float_t int_ZNuNuG_phoscaleUp = histo_ZNuNuG_phoscaleUp->Integral();
  Float_t int_ZNuNuG_phoscaleDown = histo_ZNuNuG_phoscaleDown->Integral();
  ...
  double phoscaleerr_ZNuNuG = (fabs(int_ZNuNuG_phoscaleUp-int_ZNuNuG)+fabs(int_ZNuNuG_phoscaleDown-int_ZNuNuG))/2.0;
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_ZNuNuG_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_ZNuNuG_phoscaleDown->GetBinContent(i);
    ...
    //added for test not sure 21 sept22
    phoscaleup_shift[i-1] += phoscaleup-int_bin;
    phoscaledown_shift[i-1] += phoscaledown-int_bin;
    //added finish
    ...
    cout<<"ZNuNuG: bin="<<i<<",int_bin="<<int_bin<<",jesup="<<jesup<<",jesdown="<<jesdown<<",pesup="<<pesup<<",pesdown="<<pesdown<<", phoscaleup="<<phoscaleup<<" ,phoscaledown"<<phoscaledown<<endl;
    
    double err_bin = 0.0;
    if(int_bin > 0)
      err_bin = int_bin*sqrt((2.116e-01*int_lumi*scale_factor*frac_above0p5-int_bin)/(636354*int_bin));
        histo_ZNuNuG->SetBinError(i,err_bin);  //7april
    err_bin = 0.0;
    if(int_bin_uncorrected > 0)
      err_bin = int_bin_uncorrected*sqrt((2.116e-01*int_lumi*scale_factor*frac_above0p5-int_bin_uncorrected)/(636354*int_bin_uncorrected));
        histo_ZNuNuG_uncorrected->SetBinError(i,err_bin); //7april
  }
  Float_t err_ZNuNuG = 0.0;
  if(int_ZNuNuG > 0.0){
    err_ZNuNuG = sqrt(int_ZNuNuG*int_ZNuNuG*((photon_scale_factor_unc*photon_scale_factor_unc)+(2.116e-01*int_lumi*scale_factor*frac_above0p5-int_ZNuNuG)/(636354*int_ZNuNuG))+(qcdscaleerr_ZNuNuG*qcdscaleerr_ZNuNuG)+(jeserr_ZNuNuG*jeserr_ZNuNuG)+(peserr_ZNuNuG*peserr_ZNuNuG)+(phoscaleerr_ZNuNuG*phoscaleerr_ZNuNuG)+(pdferr_ZNuNuG*pdferr_ZNuNuG)+(straighterr_ZNuNuG*straighterr_ZNuNuG)+(twistederr_ZNuNuG*twistederr_ZNuNuG)+(gammaerr_ZNuNuG*gammaerr_ZNuNuG));
    if(histname == "Photon_Et_range_24"){
      cout<<"ZnnG fractional errors:"<<int_ZNuNuG<<endl;
      cout<<"stat err = "<<sqrt(((2.116e-01*int_lumi*scale_factor*frac_above0p5-int_ZNuNuG)/(636354 *int_ZNuNuG)))<<endl;
      cout<<"jes err = "<<jeserr_ZNuNuG/int_ZNuNuG<<endl;
      cout<<"pes err = "<<peserr_ZNuNuG/int_ZNuNuG<<endl;
      cout<<"phoSF err = "<<phoscaleerr_ZNuNuG/int_ZNuNuG<<endl;
      ...
      cout<<"Total systematic = "<<sqrt(pow(jeserr_ZNuNuG,2)+pow(peserr_ZNuNuG,2)+pow(phoscaleerr_ZNuNuG,2) +pow(straighterr_ZNuNuG,2)+pow(twistederr_ZNuNuG,2)+pow(gammaerr_ZNuNuG,2)+pow(pdferr_ZNuNuG,2)+pow(photon_scale_factor_unc*int_ZNuNuG,2)+pow(qcdscaleerr_ZNuNuG,2))/int_ZNuNuG<<endl;
      cout<<endl;
    }
  }
  ...
  TFile* f_WG = new TFile("WGJets_new.root");
  //  TFile* f_WG = new TFile("WG_LO_private.root"); //WG_LO Private 5million stats 
  ...
  //below lines are added Sept21,22                                                                                                                                      
  TH1F* histo_WG_phoscaleUp = (TH1F*)((TH1F*)f_WG->Get(histname_phoSFUp))->Clone("histo_WG_phoscaleUp");
  histo_WG_phoscaleUp->SetBinContent(nBins, histo_WG_phoscaleUp->GetBinContent(nBins)+histo_WG_phoscaleUp->GetBinContent(nBins+1));
  histo_WG_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_WG_phoscaleDown = (TH1F*)((TH1F*)f_WG->Get(histname_phoSFDown))->Clone("histo_WG_phoscaleDown");
  histo_WG_phoscaleDown->SetBinContent(nBins, histo_WG_phoscaleDown->GetBinContent(nBins)+histo_WG_phoscaleDown->GetBinContent(nBins+1));
  histo_WG_phoscaleDown->ClearUnderflowAndOverflow();
  //added line ends here
  ...
  histo_WG_gammaUp_ext->SetBinxsContent(nBins, histo_WG_gammaUp_ext->GetBinContent(nBins)+histo_WG_gammaUp_ext->GetBinContent(nBins+1));
  ...
  */
  // 8.093e-01/3609634 //Old sample,    // New sample with higer stats  8.073e-01/3609634.0
  histo_WG->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0); // 502176(standard) + 1852305(ext) + 28115406(mitExt) = 30469887
  histo_WG_JESUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_JESDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_PESUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_PESDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_straightUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_straightDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_twistedUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_twistedDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_gammaUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_gammaDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  histo_WG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);

  histo_WG_qcdscale->Scale(int_lumi*scale_factor*frac_above0p5*8.073e-01/3609634.0);
  ...
  Float_t int_WG_phoscaleUp = histo_WG_phoscaleUp->Integral();
  Float_t int_WG_phoscaleDown = histo_WG_phoscaleDown->Integral();
  ...
  double phoscaleerr_WG = (fabs(int_WG_phoscaleUp-int_WG)+fabs(int_WG_phoscaleDown-int_WG))/2.0;
  double err_WG = (fabs(int_WG_PESUp-int_WG)+fabs(int_WG_PESDown-int_WG))/2.0;
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_WG_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_WG_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
    ...
    double err_bin = 0.0;
    if(int_bin > 0)
      err_bin = int_bin*sqrt((8.073e-01*int_lumi*scale_factor*frac_above0p5-int_bin)/(3609634.0*int_bin));
        histo_WG->SetBinError(i,err_bin); //7april
  }
  //  Float_t err_WG = 0.0;
  if(int_WG > 0.0){
    err_WG = sqrt(int_WG*int_WG*((photon_scale_factor_unc*photon_scale_factor_unc)+(8.073e-01*int_lumi*scale_factor*frac_above0p5-int_WG)/(3609634.0*int_WG))+(qcdscaleerr_WG*qcdscaleerr_WG)+(jeserr_WG*jeserr_WG)+(phoscaleerr_WG*phoscaleerr_WG)+(peserr_WG*peserr_WG)+(straighterr_WG*straighterr_WG)+(twistederr_WG*twistederr_WG)+(gammaerr_WG*gammaerr_WG)+(pdferr_WG*pdferr_WG));
    if(histname == "Photon_Et_range_24"){
      cout<<"WG fractional errors:"<<int_WG<<endl;
      cout<<"stat err = "<<sqrt(((8.073e-01*int_lumi*scale_factor*frac_above0p5-int_WG)/(3609634.0*int_WG)))<<endl;
      cout<<"jes err = "<<jeserr_WG/int_WG<<endl;
      cout<<"pes err = "<<peserr_WG/int_WG<<endl;
      cout<<"phoSF err = "<<phoscaleerr_WG/int_WG<<endl;
      cout<<"pdf err = "<<pdferr_WG/int_WG<<endl;
      cout<<"pix seed sf * pho id sf err = "<<photon_scale_factor_unc<<endl;
      cout<<"qcdscale err = "<<qcdscaleerr_WG/int_WG<<endl;
      cout<<"Total systematic = "<<sqrt(pow(jeserr_WG,2)+pow(peserr_WG,2)+pow(phoscaleerr_WG,2)+pow(straighterr_WG,2)+pow(twistederr_WG,2)+pow(gammaerr_WG,2)+pow(pdferr_WG,2)+pow(photon_scale_factor_unc*int_WG,2)+pow(qcdscaleerr_WG,2))/int_WG<<endl;
  ...
  TFile *f_GJets_40to100 = new TFile(TString("GJets_DR-0p4_HT-40To100_new.root"));
  TFile *f_GJets_100to200 = new TFile(TString("GJets_DR-0p4_HT-100To200_new.root"));
  TFile *f_GJets_200to400 = new TFile(TString("GJets_DR-0p4_HT-200To400_new.root"));
  TFile *f_GJets_400to600 = new TFile(TString("GJets_DR-0p4_HT-400To600_new.root"));
  TFile *f_GJets_600toInf = new TFile(TString("GJets_DR-0p4_HT-600ToInf_new.root"));
  ...
  //added 2 line below 21sep 22
  TH1F* histo_GJets_40to100_phoscaleUp = (TH1F*)((TH1F*)f_GJets_40to100->Get(histname_phoSFUp));
  TH1F* histo_GJets_40to100_phoscaleDown = (TH1F*)((TH1F*)f_GJets_40to100->Get(histname_phoSFDown));
  // added line end similar thing with other histogram for Gjet with diffreent pt range for phoscaleup and phoscaledown
  ...
  TH1F* histo_GJets_100to200_phoscaleUp = (TH1F*)((TH1F*)f_GJets_100to200->Get(histname_phoSFUp));
  TH1F* histo_GJets_100to200_phoscaleDown = (TH1F*)((TH1F*)f_GJets_100to200->Get(histname_phoSFDown));
  ...
  TH1F* histo_GJets_200to400_phoscaleUp = (TH1F*)((TH1F*)f_GJets_200to400->Get(histname_phoSFUp));
  TH1F* histo_GJets_200to400_phoscaleDown = (TH1F*)((TH1F*)f_GJets_200to400->Get(histname_phoSFDown));
  ...
  TH1F* histo_GJets_400to600_phoscaleUp = (TH1F*)((TH1F*)f_GJets_400to600->Get(histname_phoSFUp));
  TH1F* histo_GJets_400to600_phoscaleDown = (TH1F*)((TH1F*)f_GJets_400to600->Get(histname_phoSFDown));
  ...
  TH1F* histo_GJets_600toInf_phoscaleUp = (TH1F*)((TH1F*)f_GJets_600toInf->Get(histname_phoSFUp));
  TH1F* histo_GJets_600toInf_phoscaleDown = (TH1F*)((TH1F*)f_GJets_600toInf->Get(histname_phoSFDown));
  ...
  histo_GJets_40to100_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/8984790);
  histo_GJets_40to100_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/8984790);
  ...
  histo_GJets_100to200_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/10034997);
  histo_GJets_100to200_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/10034997);
  ...
  histo_GJets_200to400_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1128.0/33884844);
  histo_GJets_200to400_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*1128.0/33884844);
  ...
  histo_GJets_400to600_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.265e+02/9022800);
  histo_GJets_400to600_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.265e+02/9022800);
  ...
  histo_GJets_600toInf_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*4.124e+01 /8330226);
  histo_GJets_600toInf_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*4.124e+01 /8330226);
  ...
  Float_t int_GJets_40to100_phoscaleUp = histo_GJets_40to100_phoscaleUp->Integral();
  Float_t int_GJets_40to100_phoscaleDown = histo_GJets_40to100_phoscaleDown->Integral();
  ...
  double phoscaleerr_GJets_40to100 = (fabs(int_GJets_40to100_phoscaleUp-int_GJets_40to100)+fabs(int_GJets_40to100_phoscaleDown-int_GJets_40to100))/2.0;
  ...
  Float_t int_GJets_100to200_phoscaleUp = histo_GJets_100to200_phoscaleUp->Integral();
  Float_t int_GJets_100to200_phoscaleDown = histo_GJets_100to200_phoscaleDown->Integral();
  ...
  double phoscaleerr_GJets_100to200 = (fabs(int_GJets_100to200_phoscaleUp-int_GJets_100to200)+fabs(int_GJets_100to200_phoscaleDown-int_GJets_100to200))/2.0;
  ...
  Float_t int_GJets_200to400_phoscaleUp = histo_GJets_200to400_phoscaleUp->Integral();
  Float_t int_GJets_200to400_phoscaleDown = histo_GJets_200to400_phoscaleDown->Integral();
  ...
  double phoscaleerr_GJets_200to400 = (fabs(int_GJets_200to400_phoscaleUp-int_GJets_200to400)+fabs(int_GJets_200to400_phoscaleDown-int_GJets_200to400))/2.0;
  ...
  Float_t int_GJets_400to600_phoscaleUp = histo_GJets_400to600_phoscaleUp->Integral();
  Float_t int_GJets_400to600_phoscaleDown = histo_GJets_400to600_phoscaleDown->Integral();  
  ...
  double phoscaleerr_GJets_400to600 = (fabs(int_GJets_400to600_phoscaleUp-int_GJets_400to600)+fabs(int_GJets_400to600_phoscaleDown-int_GJets_400to600))/2.0;
  ...
  Float_t int_GJets_600toInf_phoscaleUp = histo_GJets_600toInf_phoscaleUp->Integral();
  Float_t int_GJets_600toInf_phoscaleDown = histo_GJets_600toInf_phoscaleDown->Integral();
  ...
  double phoscaleerr_GJets_600toInf = (fabs(int_GJets_600toInf_phoscaleUp-int_GJets_600toInf)+fabs(int_GJets_600toInf_phoscaleDown-int_GJets_600toInf))/2.0;
  ...
  if(int_GJets_40to100>0.0)
    err_GJets_40to100 = sqrt(int_GJets_40to100*int_GJets_40to100*((photon_scale_factor_unc*photon_scale_factor_unc)+(18700.0*int_lumi*scale_factor*frac_above0p5-int_GJets_40to100)/(8984790*int_GJets_40to100))+(jeserr_GJets_40to100*jeserr_GJets_40to100)+(peserr_GJets_40to100*peserr_GJets_40to100)+(phoscaleerr_GJets_40to100*phoscaleerr_GJets_40to100));
  if(int_GJets_100to200>0.0)
    err_GJets_100to200 = sqrt(int_GJets_100to200*int_GJets_100to200*((photon_scale_factor_unc*photon_scale_factor_unc)+(5034.0*int_lumi*scale_factor*frac_above0p5-int_GJets_100to200)/(10034997*int_GJets_100to200))+(jeserr_GJets_100to200*jeserr_GJets_100to200)+(peserr_GJets_100to200*peserr_GJets_100to200)+(phoscaleerr_GJets_100to200*phoscaleerr_GJets_100to200));
  if(int_GJets_200to400>0.0)
    err_GJets_200to400 = sqrt(int_GJets_200to400*int_GJets_200to400*((photon_scale_factor_unc*photon_scale_factor_unc)+(1128.0*int_lumi*scale_factor*frac_above0p5-int_GJets_200to400)/(33884844*int_GJets_200to400))+(jeserr_GJets_200to400*jeserr_GJets_200to400)+(peserr_GJets_200to400*peserr_GJets_200to400)+(phoscaleerr_GJets_200to400*phoscaleerr_GJets_200to400));
  if(int_GJets_400to600>0.0)
    err_GJets_400to600 = sqrt(int_GJets_400to600*int_GJets_400to600*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.265e+02*int_lumi*scale_factor*frac_above0p5-int_GJets_400to600)/(9022800*int_GJets_400to600))+(jeserr_GJets_400to600*jeserr_GJets_400to600)+(peserr_GJets_400to600*peserr_GJets_400to600)+(phoscaleerr_GJets_400to600*phoscaleerr_GJets_400to600));
  if(int_GJets_600toInf>0.0)
    err_GJets_600toInf = sqrt(int_GJets_600toInf*int_GJets_600toInf*((photon_scale_factor_unc*photon_scale_factor_unc)+( 4.124e+01 *int_lumi*scale_factor*frac_above0p5-int_GJets_600toInf)/(8330226*int_GJets_600toInf))+(jeserr_GJets_600toInf*jeserr_GJets_600toInf)+(peserr_GJets_600toInf*peserr_GJets_600toInf)+(phoscaleerr_GJets_600toInf *phoscaleerr_GJets_600toInf));
  ...
  TH1F* histo_GJets_40toInf_phoscaleUp = (TH1F*)histo_GJets_40to100->Clone("histo_GJets_phoscaleUp");
  TH1F* histo_GJets_40toInf_phoscaleDown = (TH1F*)histo_GJets_40to100->Clone("histo_GJets_phoscaleDown");
  ...
  histo_GJets_40toInf_phoscaleUp->Add(histo_GJets_100to200_phoscaleUp);
  histo_GJets_40toInf_phoscaleUp->Add(histo_GJets_200to400_phoscaleUp);
  histo_GJets_40toInf_phoscaleUp->Add(histo_GJets_400to600_phoscaleUp);
  histo_GJets_40toInf_phoscaleUp->Add(histo_GJets_600toInf_phoscaleUp);
  histo_GJets_40toInf_phoscaleDown->Add(histo_GJets_100to200_phoscaleDown);
  histo_GJets_40toInf_phoscaleDown->Add(histo_GJets_200to400_phoscaleDown);
  histo_GJets_40toInf_phoscaleDown->Add(histo_GJets_400to600_phoscaleDown);
  histo_GJets_40toInf_phoscaleDown->Add(histo_GJets_600toInf_phoscaleDown);
  ...
  //DEBUG
   ...
   //LO samle we are using 
   //TFile *f_ZllG_130_under300 = new TFile("ZLLGJets.root"); 544413, 2.059e-01
   //TFile *f_ZllG_130_under300 = new TFile("ZllGJets_LO.root"); //LO 458316, 1.931e-01
   TFile *f_ZllG_130_under300 = new TFile("ZllGJets_LO_new.root"); //LO full sample, 1.931e-01
  ...
  //added below two line 21 sept 22
  TH1F* histo_ZllG_phoscaleUp_130_under300 = (TH1F*)((TH1F*)f_ZllG_130_under300->Get(histname_phoSFUp))->Clone("histo_ZllG_phoscaleUp_130_under300");
  histo_ZllG_phoscaleUp_130_under300->SetBinContent(nBins, histo_ZllG_phoscaleUp_130_under300->GetBinContent(nBins)+histo_ZllG_phoscaleUp_130_under300->GetBinContent(nBins+1));
  histo_ZllG_phoscaleUp_130_under300->ClearUnderflowAndOverflow();

  TH1F* histo_ZllG_phoscaleDown_130_under300 = (TH1F*)((TH1F*)f_ZllG_130_under300->Get(histname_phoSFDown))->Clone("histo_ZllG_phoscaleDown_130_under300");
  histo_ZllG_phoscaleDown_130_under300->SetBinContent(nBins, histo_ZllG_phoscaleDown_130_under300->GetBinContent(nBins)+histo_ZllG_phoscaleDown_130_under300->GetBinContent(nBins+1));
  histo_ZllG_phoscaleDown_130_under300->ClearUnderflowAndOverflow();
  //lines ended
  ...
  */
  ...
  //histo_ZllG_qcdscale_300->ClearUnderflowAndOverflow();
    histo_ZllG_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_JESUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_JESDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_PESUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_PESDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_straightUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_straightDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_twistedUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_twistedDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_gammaUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_gammaDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_gammaDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_phoscaleUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_phoscaleDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  histo_ZllG_qcdscale_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/2159130);
  ...
  */
  ...
  TH1F* histo_ZllG_phoscaleUp_combined = (TH1F*)histo_ZllG_phoscaleUp_130_under300->Clone("histo_ZllG_phoscaleUp_combined");
  TH1F* histo_ZllG_phoscaleDown_combined = (TH1F*)histo_ZllG_phoscaleDown_130_under300->Clone("histo_ZllG_phoscaleDown_combined");
  ...
  histo_ZllG_phoscaleUp_combined->Add(histo_ZllG_phoscaleUp_130_under300);
  histo_ZllG_phoscaleDown_combined->Add(histo_ZllG_phoscaleDown_130_under300);
  ...
  Float_t int_ZllG_phoscaleUp = histo_ZllG_phoscaleUp_combined->Integral();
  Float_t int_ZllG_phoscaleDown = histo_ZllG_phoscaleDown_combined->Integral();
  ...
  double phoscaleerr_ZllG = (fabs(int_ZllG_phoscaleUp-int_ZllG)+fabs(int_ZllG_phoscaleDown-int_ZllG))/2.0;
  ...
  if(histname == "Photon_Et_range_24" || histname == "h_photonic_recoil_24" || histname == "h_phoRecoilMt_24"){
    ...
    TString filename = TString("histos_"+xaxis_variable+"_ZnnG_pdfscale_ZLLGJets_130_over300.root");
    ...
    histo_ZllG_PDFUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZnnG_pdfscale_ZLLGJets_130_over300_pdfUp");
    histo_ZllG_PDFDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZnnG_pdfscale_ZLLGJets_130_over300_pdfDown");
    ...
    //    TH1F* histo_ZllG_PDFUp_300 =(TH1F*) histo_ZllG_PDFUp_130_under300->Clone(); 
    // TH1F* histo_ZllG_PDFDown_300 = (TH1F*)histo_ZllG_PDFDown_130_under300->Clone(); 
    //    histo_ZllG_PDFUp_300->Scale(frac_above0p5);

    histo_ZllG_PDFUp_130_under300->Scale(frac_above0p5);
    histo_ZllG_PDFDown_130_under300->Scale(frac_above0p5);
    //histo_ZllG_PDFDown_300->Scale(frac_above0p5);
    //Float_t int_ZllG_PDFUp = histo_ZllG_PDFUp_300->Integral();
    Float_t int_ZllG_PDFUp = histo_ZllG_PDFUp_130_under300->Integral();

    //    Float_t int_ZllG_PDFDown = histo_ZllG_PDFDown_300->Integral();
    Float_t int_ZllG_PDFDown = histo_ZllG_PDFDown_130_under300->Integral();
    pdferr_ZllG = (fabs(int_ZllG_PDFUp-int_ZllG)+fabs(int_ZllG_PDFDown-int_ZllG))/2.0;
    cout<<"abcd"<<pdferr_ZllG<<endl;       
  }
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_ZllG_phoscaleUp_combined->GetBinContent(i);
    double phoscaledown = histo_ZllG_phoscaleDown_combined->GetBinContent(i);
    ...
    if(histname == "Photon_Et_range_24" || histname == "h_photonic_recoil_24" || histname == "h_phoRecoilMt_24"){
      ...
      double pdfup =  histo_ZllG_PDFUp_130_under300->GetBinContent(i);
      double pdfdown =  histo_ZllG_PDFDown_130_under300->GetBinContent(i);
      pdfup_shift[i-1] += pdfup-int_bin;
      pdfdown_shift[i-1] += pdfdown-int_bin;
    ...
    double err_bin = 0.0;
    if(int_bin > 0)
      //err_bin = sqrt(int_bin_130_under300*(1.931e-01*int_lumi*scale_factor-int_bin_130_under300)/2159130 + int_bin_300*(0.0092*int_lumi*scale_factor-int_bin_300)/1707773.0);
      err_bin = sqrt(int_bin_130_under300*(1.931e-01*int_lumi*scale_factor-int_bin_130_under300)/2159130);
        histo_ZllG_combined->SetBinError(i,err_bin); //7april
  }
  Float_t err_ZllG = 0.0;
  if(histname == "Photon_Et_range_24"){
    cout<<"ZllG fractional errors"<<endl;
    cout<<"ZllG_130_under300 stat err: "<<sqrt((1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(2159130*int_ZllG_130_under300))/int_ZllG_130_under300<<endl;
    ...
    cout<<"photonSFerr_ZllG: "<<phoscaleerr_ZllG/int_ZllG<<endl;
  ...
  if(int_ZllG > 0.0)
    //    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(2159130*int_ZllG_130_under300))+int_ZllG_300*int_ZllG_300*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.0092*int_lumi*scale_factor-int_ZllG_300)/(1707773.0*int_ZllG_300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));


    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(2159130*int_ZllG_130_under300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(phoscaleerr_ZllG*phoscaleerr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));
  ...
  TFile *f_TTG = new TFile("TTGJets_new.root");
  ...
  //added two lines below 21 sep 22
  TH1F* histo_TTG_phoscaleUp = (TH1F*)((TH1F*)f_TTG->Get(histname_phoSFUp))->Clone("histo_TTG_phoscaleUp");
  histo_TTG_phoscaleUp->SetBinContent(nBins, histo_TTG_phoscaleUp->GetBinContent(nBins)+histo_TTG_phoscaleUp->GetBinContent(nBins+1));
  histo_TTG_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_TTG_phoscaleDown = (TH1F*)((TH1F*)f_TTG->Get(histname_phoSFDown))->Clone("histo_TTG_phoscaleDown");
  histo_TTG_phoscaleDown->SetBinContent(nBins, histo_TTG_phoscaleDown->GetBinContent(nBins)+histo_TTG_phoscaleDown->GetBinContent(nBins+1));
  histo_TTG_phoscaleDown->ClearUnderflowAndOverflow();
  //ended 
  ...
  histo_TTG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*3.779e+00/3534208);
  histo_TTG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*3.779e+00/3534208);
  ...
  Float_t int_TTG_phoscaleUp = histo_TTG_phoscaleUp->Integral();
  Float_t int_TTG_phoscaleDown = histo_TTG_phoscaleDown->Integral();
  ...
  double phoscaleerr_TTG = (fabs(int_TTG_phoscaleUp-int_TTG)+fabs(int_TTG_phoscaleDown-int_TTG))/2.0;
  Float_t err_TTG = 0.0;
  if(int_TTG > 0.0)
    err_TTG = sqrt(int_TTG*int_TTG*((photon_scale_factor_unc*photon_scale_factor_unc)+(3.779e+00*int_lumi*scale_factor*frac_above0p5-int_TTG)/(3534208*int_TTG))+(jeserr_TTG*jeserr_TTG)+(peserr_TTG*peserr_TTG)+(phoscaleerr_TTG*phoscaleerr_TTG));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_TTG_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_TTG_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
  ...
  TFile *f_TG = new TFile("TGJets_new.root");
  ...
  TH1F* histo_TG_phoscaleUp = (TH1F*)((TH1F*)f_TG->Get(histname_phoSFUp))->Clone("histo_TG_phoscaleUp");
  histo_TG_phoscaleUp->SetBinContent(nBins, histo_TG_phoscaleUp->GetBinContent(nBins)+histo_TG_phoscaleUp->GetBinContent(nBins+1));
  histo_TG_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_TG_phoscaleDown = (TH1F*)((TH1F*)f_TG->Get(histname_phoSFDown))->Clone("histo_TG_phoscaleDown");
  histo_TG_phoscaleDown->SetBinContent(nBins, histo_TG_phoscaleDown->GetBinContent(nBins)+histo_TG_phoscaleDown->GetBinContent(nBins+1));
  histo_TG_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_TG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*3.055/1965000.0);
  histo_TG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*3.055/1965000.0);
  ...
  Float_t int_TG_phoscaleUp = histo_TG_phoscaleUp->Integral();
  Float_t int_TG_phoscaleDown = histo_TG_phoscaleDown->Integral();
  ...
  double phoscaleerr_TG = (fabs(int_TG_phoscaleUp-int_TG)+fabs(int_TG_phoscaleDown-int_TG))/2.0;
  Float_t err_TG = 0.0;
  if(int_TG > 0.0)
    err_TG = sqrt(int_TG*int_TG*((photon_scale_factor_unc*photon_scale_factor_unc)+(3.055*int_lumi*scale_factor*frac_above0p5-int_TG)/(1965000.0*int_TG))+(jeserr_TG*jeserr_TG)+(peserr_TG*peserr_TG)+(phoscaleerr_TG*phoscaleerr_TG));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_TG_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_TG_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
  ...
  TFile* f_diphoton = new TFile("DiPhotonJets_new.root");
  ...
  TH1F* histo_diphoton_phoscaleUp = (TH1F*)((TH1F*)f_diphoton->Get(histname_phoSFUp))->Clone("histo_diphoton_phoscaleUp");
  histo_diphoton_phoscaleUp->SetBinContent(nBins, histo_diphoton_phoscaleUp->GetBinContent(nBins)+histo_diphoton_phoscaleUp->GetBinContent(nBins+1));
  histo_diphoton_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_diphoton_phoscaleDown = (TH1F*)((TH1F*)f_diphoton->Get(histname_phoSFDown))->Clone("histo_diphoton_phoscaleDown");
  histo_diphoton_phoscaleDown->SetBinContent(nBins, histo_diphoton_phoscaleDown->GetBinContent(nBins)+histo_diphoton_phoscaleDown->GetBinContent(nBins+1));
  histo_diphoton_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_diphoton_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.273e+02/4828755);
  histo_diphoton_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*1.273e+02/4828755);
  ...
  Float_t int_diphoton_phoscaleUp = histo_diphoton_phoscaleUp->Integral();
  Float_t int_diphoton_phoscaleDown = histo_diphoton_phoscaleDown->Integral();
  ...
  double phoscaleerr_diphoton = (fabs(int_diphoton_phoscaleUp-int_diphoton)+fabs(int_diphoton_phoscaleDown-int_diphoton))/2.0;
  Float_t err_diphoton = 0.0;
  if(int_diphoton > 0.0)
    err_diphoton = sqrt(int_diphoton*int_diphoton*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.273e+02*int_lumi*scale_factor*frac_above0p5-int_diphoton)/(4828755*int_diphoton))+(jeserr_diphoton*jeserr_diphoton)+(peserr_diphoton*peserr_diphoton)+(phoscaleerr_diphoton*phoscaleerr_diphoton));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_diphoton_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_diphoton_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
  ...
  TFile *f_WZ = new TFile("WZ_new.root");
  ...
  TH1F* histo_WZ_phoscaleUp = (TH1F*)((TH1F*)f_WZ->Get(histname_phoSFUp))->Clone("histo_WZ_phoscaleUp");
  histo_WZ_phoscaleUp->SetBinContent(nBins, histo_WZ_phoscaleUp->GetBinContent(nBins)+histo_WZ_phoscaleUp->GetBinContent(nBins+1));
  histo_WZ_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_WZ_phoscaleDown = (TH1F*)((TH1F*)f_WZ->Get(histname_phoSFDown))->Clone("histo_WZ_phoscaleDown");
  histo_WZ_phoscaleDown->SetBinContent(nBins, histo_WZ_phoscaleDown->GetBinContent(nBins)+histo_WZ_phoscaleDown->GetBinContent(nBins+1));
  histo_WZ_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_WZ_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*2.756e+01/7889000);
  histo_WZ_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*2.756e+01/7889000);
  ...
  Float_t int_WZ_phoscaleUp = histo_WZ_phoscaleUp->Integral();
  Float_t int_WZ_phoscaleDown = histo_WZ_phoscaleDown->Integral();
  ...
  double phoscaleerr_WZ = (fabs(int_WZ_phoscaleUp-int_WZ)+fabs(int_WZ_phoscaleDown-int_WZ))/2.0;
  Float_t err_WZ = 0.0;
  if(int_WZ > 0.0)
    err_WZ = sqrt(int_WZ*int_WZ*((photon_scale_factor_unc*photon_scale_factor_unc)+(2.756e+01*int_lumi*scale_factor*frac_above0p5-int_WZ)/(7889000*int_WZ))+(jeserr_WZ*jeserr_WZ)+(peserr_WZ*peserr_WZ)+(phoscaleerr_WZ*phoscaleerr_WZ));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_WZ_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_WZ_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
  ...
  TFile *f_ZZ = new TFile("ZZ_new.root");
  ...
  TH1F* histo_ZZ_phoscaleUp = (TH1F*)((TH1F*)f_ZZ->Get(histname_phoSFUp))->Clone("histo_ZZ_phoscaleUp");
  histo_ZZ_phoscaleUp->SetBinContent(nBins, histo_ZZ_phoscaleUp->GetBinContent(nBins)+histo_ZZ_phoscaleUp->GetBinContent(nBins+1));
  histo_ZZ_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_ZZ_phoscaleDown = (TH1F*)((TH1F*)f_ZZ->Get(histname_phoSFDown))->Clone("histo_ZZ_phoscaleDown");
  histo_ZZ_phoscaleDown->SetBinContent(nBins, histo_ZZ_phoscaleDown->GetBinContent(nBins)+histo_ZZ_phoscaleDown->GetBinContent(nBins+1));
  histo_ZZ_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_ZZ_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.214e+01/2706000);
  histo_ZZ_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*1.214e+01/2706000);
  ...
  Float_t int_ZZ_phoscaleUp = histo_ZZ_phoscaleUp->Integral();
  Float_t int_ZZ_phoscaleDown = histo_ZZ_phoscaleDown->Integral();
  ...
  double phoscaleerr_ZZ = (fabs(int_ZZ_phoscaleUp-int_ZZ)+fabs(int_ZZ_phoscaleDown-int_ZZ))/2.0;
  Float_t err_ZZ = 0.0;
  if(int_ZZ > 0.0)
    err_ZZ = sqrt(int_ZZ*int_ZZ*((1.214e+01*int_lumi*scale_factor*frac_above0p5-int_ZZ)/(2706000*int_ZZ))+(jeserr_ZZ*jeserr_ZZ)+(peserr_ZZ*peserr_ZZ)+(phoscaleerr_ZZ*phoscaleerr_ZZ));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_ZZ_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_ZZ_phoscaleDown->GetBinContent(i);
    jesup_shift[i-1] += jesup-int_bin;
    jesdown_shift[i-1] += jesdown-int_bin;
    pesup_shift[i-1] += pesup-int_bin;
    pesdown_shift[i-1] += pesdown-int_bin;
  ...
  TFile *f_WMuNu = new TFile("WToMuNu_M_new.root");
  ...
  TH1F* histo_WMuNu_phoscaleUp = (TH1F*)((TH1F*)f_WMuNu->Get(histname_phoSFUp))->Clone("histo_WMuNu_phoscaleUp");
  histo_WMuNu_phoscaleUp->SetBinContent(nBins, histo_WMuNu_phoscaleUp->GetBinContent(nBins)+histo_WMuNu_phoscaleUp->GetBinContent(nBins+1));
  histo_WMuNu_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_WMuNu_phoscaleDown = (TH1F*)((TH1F*)f_WMuNu->Get(histname_phoSFDown))->Clone("histo_WMuNu_phoscaleDown");
  histo_WMuNu_phoscaleDown->SetBinContent(nBins, histo_WMuNu_phoscaleDown->GetBinContent(nBins)+histo_WMuNu_phoscaleDown->GetBinContent(nBins+1));
  histo_WMuNu_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_WMuNu_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.742e+02/1986000);
  histo_WMuNu_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*1.742e+02/1986000);
  ...
  Float_t int_WMuNu_phoscaleUp = histo_WMuNu_phoscaleUp->Integral();
  Float_t int_WMuNu_phoscaleDown = histo_WMuNu_phoscaleDown->Integral();
  ...
  double phoscaleerr_WMuNu = (fabs(int_WMuNu_phoscaleUp-int_WMuNu)+fabs(int_WMuNu_phoscaleDown-int_WMuNu))/2.0;
  Float_t err_WMuNu = 0.0;
  if(int_WMuNu > 0.0)
    err_WMuNu = sqrt(int_WMuNu*int_WMuNu*((1.742e+02*int_lumi*scale_factor*frac_above0p5-int_WMuNu)/(1986000*int_WMuNu))+(jeserr_WMuNu*jeserr_WMuNu)+(peserr_WMuNu*peserr_WMuNu)+(phoscaleerr_WMuNu*phoscaleerr_WMuNu));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_WMuNu_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_WMuNu_phoscaleDown->GetBinContent(i);
  ...
  TFile *f_WTauNu = new TFile("WToTauNu_new.root");
  ...
  TH1F* histo_WTauNu_phoscaleUp = (TH1F*)((TH1F*)f_WTauNu->Get(histname_phoSFUp))->Clone("histo_WTauNu_phoscaleUp");
  histo_WTauNu_phoscaleUp->SetBinContent(nBins, histo_WTauNu_phoscaleUp->GetBinContent(nBins)+histo_WTauNu_phoscaleUp->GetBinContent(nBins+1));
  histo_WTauNu_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_WTauNu_phoscaleDown = (TH1F*)((TH1F*)f_WTauNu->Get(histname_phoSFDown))->Clone("histo_WTauNu_phoscaleDown");
  histo_WTauNu_phoscaleDown->SetBinContent(nBins, histo_WTauNu_phoscaleDown->GetBinContent(nBins)+histo_WTauNu_phoscaleDown->GetBinContent(nBins+1));
  histo_WTauNu_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_WTauNu_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*1.741e+02 /1985000);
  histo_WTauNu_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*1.741e+02 /1985000);
  ...
  Float_t int_WTauNu_phoscaleUp = histo_WTauNu_phoscaleUp->Integral();
  Float_t int_WTauNu_phoscaleDown = histo_WTauNu_phoscaleDown->Integral();
  ...
  double phoscaleerr_WTauNu = (fabs(int_WTauNu_phoscaleUp-int_WTauNu)+fabs(int_WTauNu_phoscaleDown-int_WTauNu))/2.0;
  Float_t err_WTauNu = 0.0;
  if(int_WTauNu > 0.0)
    err_WTauNu = sqrt(int_WTauNu*int_WTauNu*((1.741e+02 *int_lumi*scale_factor*frac_above0p5-int_WTauNu)/(1985000*int_WTauNu))+(jeserr_WTauNu*jeserr_WTauNu)+(peserr_WTauNu*peserr_WTauNu)+(phoscaleerr_WTauNu*phoscaleerr_WTauNu));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_WTauNu_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_WTauNu_phoscaleDown->GetBinContent(i);
  ...
  TFile *f_WW = new TFile("WW_new.root");
  ...
  TH1F* histo_WW_phoscaleUp = (TH1F*)((TH1F*)f_WW->Get(histname_phoSFUp))->Clone("histo_WW_phoscaleUp");
  histo_WW_phoscaleUp->SetBinContent(nBins, histo_WW_phoscaleUp->GetBinContent(nBins)+histo_WW_phoscaleUp->GetBinContent(nBins+1));
  histo_WW_phoscaleUp->ClearUnderflowAndOverflow();

  TH1F* histo_WW_phoscaleDown = (TH1F*)((TH1F*)f_WW->Get(histname_phoSFDown))->Clone("histo_WW_phoscaleDown");
  histo_WW_phoscaleDown->SetBinContent(nBins, histo_WW_phoscaleDown->GetBinContent(nBins)+histo_WW_phoscaleDown->GetBinContent(nBins+1));
  histo_WW_phoscaleDown->ClearUnderflowAndOverflow();
  ...
  histo_WW_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*7.588e+01/15634000);
  histo_WW_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*7.588e+01/15634000);
  ...
  Float_t int_WW_phoscaleUp = histo_WW_phoscaleUp->Integral();
  Float_t int_WW_phoscaleDown = histo_WW_phoscaleDown->Integral();
  ...
  double phoscaleerr_WW = (fabs(int_WW_phoscaleUp-int_WW)+fabs(int_WW_phoscaleDown-int_WW))/2.0;
  Float_t err_WW = 0.0;
  if(int_WW > 0.0)
    err_WW = sqrt(int_WW*int_WW*((7.588e+01*int_lumi*scale_factor*frac_above0p5-int_WW)/(15634000*int_WW))+(jeserr_WW*jeserr_WW)+(peserr_WW*peserr_WW)+(phoscaleerr_WW*phoscaleerr_WW));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double phoscaleup = histo_WW_phoscaleUp->GetBinContent(i);
    double phoscaledown = histo_WW_phoscaleDown->GetBinContent(i);
  ...
  // TFile *f_ZZG = new TFile("ZnnG_JESPES_WGGJets.root");
  ...
  if (histname == "Photon_Et_range_24" || histname == "pfMET_24" || histname == "Mt_24") {
    ...
    TFile* f_ZnnG_histos;
    if(histname == "Photon_Et_range_24") f_ZnnG_histos = new TFile("ZnnG_histos_above0p5_Pt_official.root","RECREATE");
    else if(histname == "pfMET_24")
      f_ZnnG_histos = new TFile("ZnnG_histos_above0p5_MET_SF_WPV.root","RECREATE");
    else if(histname == "Mt_24")
      f_ZnnG_histos = new TFile("ZnnG_histos_above0p5_Mt_SF_WPV.root","RECREATE");
    f_ZnnG_histos->cd();
    histo_data->Write();
    histo_jetfake->Write();
    ...
    histo_ZNuNuG_phoscaleUp->Write();
    histo_ZNuNuG_phoscaleDown->Write();
    ...
    histo_ZNuNuG_PDFUp->Write();
    histo_ZNuNuG_PDFDown->Write();
    histo_WG->Write();
    histo_WG_JESUp->Write();
    histo_WG_JESDown->Write();
    histo_WG_phoscaleUp->Write();
    histo_WG_phoscaleDown->Write();
    ...
    histo_WG_PDFUp->Write();
    histo_WG_PDFDown->Write();
    ...
    histo_GJets_40toInf_phoscaleUp->Write();
    histo_GJets_40toInf_phoscaleDown->Write();
    ...
    histo_ZllG_phoscaleUp_combined->Write();
    histo_ZllG_phoscaleDown_combined->Write();
    ...
    histo_ZllG_PDFUp_130_under300->Write();    
    histo_ZllG_PDFDown_130_under300->Write();    
    histo_TTG->Write();
    histo_TTG_JESUp->Write();
    histo_TTG_JESDown->Write();
    histo_TTG_PESUp->Write();
    histo_TTG_PESDown->Write();
    histo_TTG_phoscaleUp->Write();
    histo_TTG_phoscaleDown->Write();
    histo_TG->Write();
    histo_TG_JESUp->Write();
    histo_TG_JESDown->Write();
    histo_TG_PESUp->Write();
    histo_TG_PESDown->Write();
    histo_TG_phoscaleUp->Write();
    histo_TG_phoscaleDown->Write();
    // histo_WWG->Write();
 ...
 histo_data_copy->Draw();
  ...
  TLatex *texS = new TLatex(0.60023,0.917173,"41.48 fb^{-1} (13 TeV)");
  texS->SetNDC();
  texS->SetTextFont(42);
