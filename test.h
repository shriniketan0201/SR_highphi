...
// Mon Mar 27 15:23:45 2023 by ROOT version 6.14/09
// from TTree eventTree/event tree for analysis
// found on file: Znunugamma_Monophoton_Ptg130_2jets_2017_4.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_LHenu1Pt;   //!
   TBranch        *b_LHenu2Pt;   //!
   TBranch        *b_LHedinuPhi;   //!
   TBranch        *b_LHenu1Phi;   //!
   TBranch        *b_LHenu2Phi;   //!
   TBranch        *b_LHedinuEta;   //!
   TBranch        *b_LHenu1Eta;   //!
   TBranch        *b_LHenu2Eta;   //!
   TBranch        *b_nLHEpho;   //!
   TBranch        *b_nLHEnu;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Znunugamma_Monophoton_Ptg130_2jets_2017_4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Znunugamma_Monophoton_Ptg130_2jets_2017_4.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Znunugamma_Monophoton_Ptg130_2jets_2017_4.root:/phoJetNtuplizer");
...
void test::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LHephoEta", &LHephoEta, &b_LHephoEta);
   fChain->SetBranchAddress("LHephoPhi", &LHephoPhi, &b_LHephoPhi);
   fChain->SetBranchAddress("LHedinuPt", &LHedinuPt, &b_LHedinuPt);
   fChain->SetBranchAddress("LHenu1Pt", &LHenu1Pt, &b_LHenu1Pt);
   fChain->SetBranchAddress("LHenu2Pt", &LHenu2Pt, &b_LHenu2Pt);
   fChain->SetBranchAddress("LHedinuPhi", &LHedinuPhi, &b_LHedinuPhi);
   fChain->SetBranchAddress("LHenu1Phi", &LHenu1Phi, &b_LHenu1Phi);
   fChain->SetBranchAddress("LHenu2Phi", &LHenu2Phi, &b_LHenu2Phi);
   fChain->SetBranchAddress("LHedinuEta", &LHedinuEta, &b_LHedinuEta);
   fChain->SetBranchAddress("LHenu1Eta", &LHenu1Eta, &b_LHenu1Eta);
   fChain->SetBranchAddress("LHenu2Eta", &LHenu2Eta, &b_LHenu2Eta);
   fChain->SetBranchAddress("nLHEpho", &nLHEpho, &b_nLHEpho);
   fChain->SetBranchAddress("nLHEnu", &nLHEnu, &b_nLHEnu);
