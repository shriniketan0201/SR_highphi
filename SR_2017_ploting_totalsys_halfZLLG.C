...

{
  ...
  */ 
  ...
  histo_ZNuNuG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636983);
  histo_ZNuNuG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636983);
  ...
  */
  ...
  if(int_ZNuNuG > 0.0){
    err_ZNuNuG = sqrt(int_ZNuNuG*int_ZNuNuG*((photon_scale_factor_unc*photon_scale_factor_unc)+(2.116e-01*int_lumi*scale_factor*frac_above0p5-int_ZNuNuG)/(636983*int_ZNuNuG))+(qcdscaleerr_ZNuNuG*qcdscaleerr_ZNuNuG)+(jeserr_ZNuNuG*jeserr_ZNuNuG)+(peserr_ZNuNuG*peserr_ZNuNuG)+(phoscaleerr_ZNuNuG*phoscaleerr_ZNuNuG)+(pdferr_ZNuNuG*pdferr_ZNuNuG)+(straighterr_ZNuNuG*straighterr_ZNuNuG)+(twistederr_ZNuNuG*twistederr_ZNuNuG)+(gammaerr_ZNuNuG*gammaerr_ZNuNuG));
    if(histname == "Photon_Et_range_24"){
  ...
  */
  ...
  histo_WG_phoscaleUp->Scale(int_lumi*scale_factor*frac_above0p5*8.093e-01/3609634);
  histo_WG_phoscaleDown->Scale(int_lumi*scale_factor*frac_above0p5*8.093e-01/3609634);
  ...
  //  Float_t err_WG = 0.0;
  if(int_WG > 0.0){
    err_WG = sqrt(int_WG*int_WG*((photon_scale_factor_unc*photon_scale_factor_unc)+(8.093e-01*int_lumi*scale_factor*frac_above0p5-int_WG)/(3609634*int_WG))+(qcdscaleerr_WG*qcdscaleerr_WG)+(jeserr_WG*jeserr_WG)+(phoscaleerr_WG*phoscaleerr_WG)+(peserr_WG*peserr_WG)+(straighterr_WG*straighterr_WG)+(twistederr_WG*twistederr_WG)+(gammaerr_WG*gammaerr_WG)+(pdferr_WG*pdferr_WG));
    if(histname == "Photon_Et_range_24"){
  ...
  //DEBUG
   ...
   TFile *f_ZllG_130_under300 = new TFile("ZllG17_half_LO.root"); //LO full sample, 1.931e-01  //half sa,ple 1079565
  ...
  */
  ...
  //histo_ZllG_qcdscale_300->ClearUnderflowAndOverflow();
    histo_ZllG_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_JESUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_JESDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_PESUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_PESDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_straightUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_straightDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_twistedUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_twistedDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_gammaUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_gammaDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_gammaDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_phoscaleUp_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_phoscaleDown_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  histo_ZllG_qcdscale_130_under300->Scale(int_lumi*scale_factor*frac_above0p5*1.931e-01/1079565);
  ...
  */
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double err_bin = 0.0;
    if(int_bin > 0)
      //err_bin = sqrt(int_bin_130_under300*(1.931e-01*int_lumi*scale_factor-int_bin_130_under300)/1079565 + int_bin_300*(0.0092*int_lumi*scale_factor-int_bin_300)/1707773.0);
      err_bin = sqrt(int_bin_130_under300*(1.931e-01*int_lumi*scale_factor-int_bin_130_under300)/1079565);
        histo_ZllG_combined->SetBinError(i,err_bin); //7april
  }
  Float_t err_ZllG = 0.0;
  if(histname == "Photon_Et_range_24"){
    cout<<"ZllG fractional errors"<<endl;
    cout<<"ZllG_130_under300 stat err: "<<sqrt((1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(1079565*int_ZllG_130_under300))/int_ZllG_130_under300<<endl;
  ...
  if(int_ZllG > 0.0)
    //    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(1079565*int_ZllG_130_under300))+int_ZllG_300*int_ZllG_300*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.0092*int_lumi*scale_factor-int_ZllG_300)/(1707773.0*int_ZllG_300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));


    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(1.931e-01*int_lumi*scale_factor-int_ZllG_130_under300)/(1079565*int_ZllG_130_under300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(phoscaleerr_ZllG*phoscaleerr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));
  ...
  if (histname == "Photon_Et_range_24" || histname == "pfMET_24" || histname == "Mt_24") {
    ...
    TFile* f_ZnnG_histos;
    if(histname == "Photon_Et_range_24") f_ZnnG_histos = new TFile("ZnnG_histos_above0p5_Pt_SF_half.root","RECREATE");
...
void  SR_2017_ploting_totalsys_halfZLLG()
{
